...
SMTP_PORT = 587
EMAIL_ADDRESS = "groceria@gmail.com"  # Replace with your email
EMAIL_PASSWORD = "bbit@123"        # Replace with your email password
...
with mysql.connect('groceria.db') as conn:
    cursor = conn.cursor()
...
## NESTED SEARCH BOX ##
    ...
    # Connect to the database
        connection = mysql.connect("groceria.db")
    ...
    def add_to_cart( product_id,product_name,price):
        try:
        	conn= mysql.connect("groceria.db")
        	cursor = conn.cursor()
        	s_mail=email_address_login.get()
