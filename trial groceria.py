...
background_image1=ctk.CTkImage(Image.open(r"wpg.png"),size=(500,400))
signup_backlabel=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=700,width=1200)
...
#login images
insta=ctk.CTkImage(Image.open(r"instagram (1).png"),size=(50,50)) 
...
def fgpass():
    window.withdraw()
    forgot_tab=Toplevel()
    forgot_tab.configure(bg='#093e44')
    ...
    #Widgets
    emadd=ctk.CTkEntry(forgottab_frame,height=80,width=500,corner_radius=30,border_width=3,                                 border_color='#0f969c',fg_color='#0c7075')
    pwd=ctk.CTkEntry(forgottab_frame,height=80,width=240,corner_radius=30,border_width=3,                            border_color='#0f969c',fg_color='#0c7075')
    ...
    feedback_label = ctk.CTkLabel(emadd, text="", font=("Helvetica", 16),bg_color='#0c7075',fg_color='#0c7075',        width=30,height=30)
...
def login():
    window.withdraw()
    login_tab=ctk.CTk()
    login_tab.configure(fg_color='#093e44')
    ...
    emadd=ctk.CTkEntry(loginframe,height=80,width=500,corner_radius=30,border_width=3,fg_color='#0c7075',border_color='#0f969c')
...
def checked():
    ...
    tabs_frame = ctk.CTkFrame(shop,height=650, width=240,fg_color='#c1e8ff',corner_radius=40,bg_color='#05161a')  
...
#menu button  
    ...
    menubtn.place(x=50,y=30)
    close_menu=ctk.CTkButton(shop,text='',height=40,width=60,command=click,image=close,fg_color='#0c7075') 
    ...
    #other buttons
    searchbox=ctk.CTkEntry(shop,fg_color='#0c7075',width=700,height=60,corner_radius=20,border_width=3,bg_color='#05161a')
...
cnfpass=ctk.CTkEntry(widgetframe_su,height=80,width=240,corner_radius=30,border_width=3,border_color='#0f969c',fg_color='#0c7075')
...
cnfpass_lbl=ctk.CTkLabel(cnfpass,text='Confirm Password',text_color='white',font=('vivaldi italics',10))
cnfpass_lbl.place(x=20,y=4)
emadd_lbl=ctk.CTkLabel(emadd,text='Email',text_color='white',font=('vivaldi italics',10))
emadd_lbl.place(x=20,y=4)
pwd_lbl=ctk.CTkLabel(pwd,text='Password',text_color='white',font=('vivaldi italics',10))
pwd_lbl.place(x=20,y=4)
...
cnfpass.place(x=280,y=260)
pwd.place(x=20,y=260)
