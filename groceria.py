...
logo_image=ctk.CTkImage(Image.open(r"logo.png"),size=(130,130))
logo_image_one=ctk.CTkImage(Image.open(r"logo.png"),size=(100,100))
...
juices = ctk.CTkImage(Image.open("juices.png"), size=(970, 160))
rice = ctk.CTkImage(Image.open("rice.png"), size=(970, 160))
cookies = ctk.CTkImage(Image.open("cookies.png"), size=(970, 160))
snacks = ctk.CTkImage(Image.open("snacks.png"), size=(970, 160))

#advertisement images for the shop window with menu button
juices_menu= ctk.CTkImage(Image.open("juices.png"), size=(720, 160))
rice_menu = ctk.CTkImage(Image.open("rice.png"), size=(720, 160))
cookies_menu= ctk.CTkImage(Image.open("cookies.png"), size=(720, 160))
snacks_menu = ctk.CTkImage(Image.open("snacks.png"), size=(720, 160))
...
def fgpass():
    forgot_password_mainframe=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
...
def checked():   
    shop_mainframe=ctk.CTkFrame(window,fg_color='#05161a',corner_radius=60,height=580,width=1060)
    shop_mainframe.place(x=30,y=30)
    logo=ctk.CTkLabel(shop_mainframe,image= logo_image,text='')
    tabs_frame = ctk.CTkFrame(shop_mainframe,height=530, width=250,fg_color='#05161a',corner_radius=40,bg_color='#05161a',border_width=3,border_color='#0c7075')  
    tabs_frame.propagate(0)
    shop_scrollframe=ctk.CTkFrame(shop_mainframe,height=440,width=1010,corner_radius=30,fg_color='#294d61',bg_color='#05161a')
    shop_scrollframe.propagate(0)
    shop_scrollframe1=ctk.CTkFrame(master=shop_mainframe,height=440,width=745,corner_radius=30,fg_color='#294d61',bg_color='#05161a')           
    shop_scrollframe1.propagate(0)
    shop_scrollframe.place(x=25,y=110)      
    logo.place(x=135,y=2) 
        
    def supplie_products():
            supplies_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
    ...
    def fruit_products():
            fruits_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
    ...
    def dairy_products():
            dairy_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
    ...
    def vegetable_products():
            vegetable_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
    ...
    advertisement.place(x=20,y=20)
    
#CATEGORY TABS
    category_frame=ctk.CTkFrame(shop_scrollframe,height=90,width=850,corner_radius=30,fg_color='#072e33',border_width=3,border_color='#093e44')    
    ...
    #placing of tabs
    category_frame.place(x=60,y=200)
    dairy.place(x=430,y=10)
    fruits.place(x=220,y=10)
    vegetables.place(x=10,y=10)    
    essentials.place(x=640,y=10)      
    ...
    category_frame_menu=ctk.CTkFrame(tabs_frame,height=150,width=210,corner_radius=30,fg_color='#072e33',border_width=3,border_color='#093e44')
...
#SEARCH TAB
    def search_tab():
            search_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
...
#PROFILE TAB      
    def profile_tab():
            profile_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
            ...
            profile_tab_one=ctk.CTkLabel(profile_frame,text='',fg_color='#294d61',height=480,width=600,corner_radius=50) 
            profile_tab_two=ctk.CTkLabel(profile_frame,text='',fg_color='#294d61',height=480,width=380,corner_radius=50)          
            ...
            edit_profile=ctk.CTkButton(profile_tab_one,text='Edit Profile',corner_radius=50,image=prof,fg_color='#0c7075',border_width=3,width=400,height=60)
            delete_button=ctk.CTkButton(profile_tab_two,text='Delete Acoount',font=('Helvetica',30),border_width=4,border_color='#811331',fg_color='#0c7075',height=60,width=280,corner_radius=30)
            ...
            bckbtn = ctk.CTkButton(profile_frame, text="", command=back, image=backbutn, fg_color='#294d61',                    hover_color='white', height=55, width=55, corner_radius=5)
            
            #placing widgets           
            profile_tab_one.place(x=30,y=70)
            profile_tab_two.place(x=650,y=70)
            tab_namelabel.place(x=220, y=10)
            delete_button.place(x=20,y=400)
            prof_image.place(x=40,y=40)
            edit_profile.place(x=100,y=400)
            bckbtn.place(x=40, y=10)
            
            lastname_label.place(x=450,y=40)
            email_address_label.place(x=300,y=100)
            fullname_label.place(x=300,y=40)
            address.place(x=300,y=200)
            pincode.place(x=300,y=300)

#  ORDERS TAB 

    def orders_tab():
            orders_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
...
#SETTINGS TAB  
    ...
    def settings_tab():
            settings_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
            settings_frame.place(x=30,y=30)
            tab_namelabel=ctk.CTkLabel(settings_frame,text='Settings',font=('Helvetica',40),fg_color='#05161a',text_color='#FFFFFF')
            tab_namelabel.place(x=220, y=10)
            def back():
 ...
 #SUPPORTS TAB  
    ...
    def supports_tab():
            supports_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
            supports_frame.place(x=30,y=30)
            tab_namelabel=ctk.CTkLabel(supports_frame,text='Help & Support',font=('Helvetica',40),fg_color='#05161a',text_color='#FFFFFF')
            tab_namelabel.place(x=220, y=10)
            def back():
 ...
 #NOTIFICATION TAB   
    ...
    def notification_tab():
            notification_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
...
#CART TAB      
    def cart_tab():
            cart_frame=ctk.CTkFrame(window,border_width=3,fg_color='#05161a',corner_radius=60,height=580,width=1060)
    ...
    #widgets in the menu
    orders = ctk.CTkButton(tabs_frame, text="Orders              ",image=open, fg_color="#FFFFFF", font=fnt1, corner_radius=20, width=210, height=40,border_width=3,compound='right',text_color='black',command=orders_tab)
    ...
    hpc = ctk.CTkButton(tabs_frame, text="Contact Us      ", fg_color="#FFFFFF", font=fnt1, corner_radius=20, width=210, height=40,image=open,border_width=3,text_color='black',compound='right',command=supports_tab)
    settings = ctk.CTkButton(tabs_frame, text="Settings          ", fg_color="#FFFFFF", font=fnt1, corner_radius=20, width=210, height=40,image=open,border_width=3,text_color='black',compound='right',command=settings_tab)
    ...
    settings.place(x=20, y=230)
    logout.place(x=20,y=450)
    
    #widgets with menu
    menu_searchbox=ctk.CTkEntry(shop_mainframe,fg_color='#0c7075',width=420,height=60,corner_radius=20,border_width=3,bg_color='#05161a')
    menu_notification_button=ctk.CTkButton(shop_mainframe,text='',image=notify,fg_color='#0c7075',width=50,height=50,corner_radius=20,border_width=3,bg_color='#05161a',command=notification_tab)
    menu_cart_button=ctk.CTkButton(shop_mainframe,text='',image=cartt,fg_color='#0c7075',width=50,height=50,corner_radius=20,border_width=3,bg_color='#05161a',command=cart_tab)
    ...
    searchbox=ctk.CTkEntry(shop_mainframe,fg_color='#0c7075',width=500,height=60,corner_radius=20,border_width=3,bg_color='#05161a')
    notification_button=ctk.CTkButton(shop_mainframe,text='',image=notify,fg_color='#0c7075',width=50,height=50,corner_radius=20,border_width=3,bg_color='#05161a',command=notification_tab)
    cart_button=ctk.CTkButton(shop_mainframe,text='',image=cartt,fg_color='#0c7075',width=50,height=50,corner_radius=20,border_width=3,bg_color='#05161a',command=cart_tab)
    ...
    notification_button.place(x=800,y=30)
    cart_button.place(x=900,y=30)
    search_button.place(x=690,y=35)
...
#MENU BUTTON FUNCTIONING AND DEFINING
    def function_one():
        ...
        menu_notification_button.place(x=810,y=30)
        menu_cart_button.place(x=920,y=30)
        menu_search_button.place(x=710,y=35)
        menu_searchbox.place(x=370,y=30)
...
# ADVERTISEMENT FUNCTION FOR SHOP WINDOW WITH MENU
    ...
    buttons_menu= [ctk.CTkButton(canvas_menu, image=image, width=720, fg_color='#294d61',height=150, command=command) for image, command in zip(images_menu, commands)]
...
google_button=ctk.CTkButton(widgetframe_su,text="",image=google,fg_color='#0c7075',hover_color='#072e33',width=60,border_width=3)
phon_button=ctk.CTkButton(widgetframe_su,text="",image=phon,width=60,fg_color='#0c7075',hover_color='white')
instagram_button=ctk.CTkButton(widgetframe_su,text="",image=instagram,width=60,fg_color='#0c7075',hover_color='white')
